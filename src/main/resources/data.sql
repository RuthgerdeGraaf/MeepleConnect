...
INSERT INTO boardgames (id, name, price, minPlayers, maxPlayers, genre, available, publisher)
VALUES
    (1, 'Mansions of Madness', 99.99, 1, 5, 'Horror', true, (SELECT id FROM publisher WHERE name = 'Fantasy Flight Games')),
    (2, 'Betrayal at House on the Hill', 49.99, 3, 6, 'Horror', true, (SELECT id FROM publisher WHERE name = 'Avalon Hill')),
    (3, 'Catan', 39.99, 3, 4, 'Strategy', true, (SELECT id FROM publisher WHERE name = 'Kosmos'));
